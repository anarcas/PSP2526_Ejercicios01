...
public class Pintor implements Runnable {
    ...
    public void run() {
        ...
        System.out.println(String.format("El %s deja de almacenar cuadros. Total de cuadros vendidos = %d", Thread.currentThread().getName(), Almacen.getNumCuadrosVendidos()));
    }
